  ...
  return (
    <div className="container" style={containerStyles}>
      ...
      <div style={{"marginBottom": "10px"}}>
        <h2>NORTHBOUND</h2>
        <div style={{"marginTop": "5px", "fontWeight": "bold"}}>STOPPED AT:</div>
        {findStopped(data.trains, "northbound").map((elem, i) => <div key={i}>{elem}</div>)}
        <div style={{"marginTop": "5px", "fontWeight": "bold"}}>APPROACHING:</div>
        {findInTransit(data.trains, "northbound").map((elem, i) => <div key={i}>{elem}</div>)}
      </div>
      <div style={{"marginBottom": "10px"}}>
      <h2>SOUTHBOUND</h2>
        <div style={{"marginTop": "5px", "fontWeight": "bold"}}>STOPPED AT:</div>
